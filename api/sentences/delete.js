...
async function handler(req, res) {
    ...
    try {
        ...
        if (sentenceData.userId !== userId) {
            return (0, response_1.createErrorResponse)(res, 'Access denied. You can only delete your own sentences', 403);
        }
        ...
        return (0, response_1.createErrorResponse)(res, 'Failed to delete sentence. Please try again', 500);
    }
}
